...
const fetchMessages = async () => {
    try {
        ...
        messages.value = response.data; // Already decrypted by the server
    } catch (err) {
...
onMounted(async () => {
    ...
    .listen('NewChatMessage', (data) => {
        ...
        // Echo.channel(`chat.${roomId.value}`)
        ...
        // If validation passes, fetch messages and members
