...
<template>
    ...
    <div class="bg-void-black min-h-screen relative overflow-hidden">
        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-blood-red selection:text-ghost-white">
                ...
                <main class="flex-grow flex items-center justify-center min-h-[80vh]">
                    <div class="text-center py-12">
                        <div class="relative inline-block">
                            <div 
                                class="absolute inset-0 bg-blood-red/30 blur-3xl -z-10 animate-pulse"
                                :style="{
